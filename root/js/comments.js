    ...
    comments.then((result) => {
      ...
      obj.comments.forEach(function (comment) {
        if (objectCommentsContainer[comment.line] != undefined) {
          objectCommentsContainer[comment.line] += `
                        <div class="comment">
                            <span class="commentAuthor">${comment.user.first_name} ${comment.user.last_name}</span>
      ...
      for (let [key, value] of Object.entries(objectCommentsContainer)) {
        ...
        commentButton.querySelector("svg").style.transition =
        ...
        commentButton.addEventListener("click", function () {
          if (commentTextContainer.style.display == "none") {
            ...
            commentButton.querySelector("svg").style.transform =
              "rotate(90deg)";
          } else {
            commentTextContainer.style.display = "none";
